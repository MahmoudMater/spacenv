...
export function CreateSpaceModal() {
  const open = useUIStore((s) => s.isCreateSpaceOpen);
      ...
      <Dialog.Portal>
        ...
        >
          ...
          <Dialog.Description className="mt-1 text-sm text-zinc-400">
            A space is your team or organization workspace.
          </Dialog.Description>
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            <div className="space-y-2">
              <Label htmlFor="space-name" className="text-zinc-200">
                Name
              </Label>
              <Input
                id="space-name"
            ...
            <div className="space-y-2">
              <Label htmlFor="space-desc" className="text-zinc-200">
                Description{" "}
